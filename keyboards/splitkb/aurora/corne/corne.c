...
#define ANIM_WPM_LOWER 20                // 40 (default) above this wpm value typing animation to trigger
#define ANIM_FRAME_DURATION_BONGOCAT 300 // 50 (rapido) 200 (default) 400 (lento) how long each frame lasts in ms
...
#define ANIM_SIZE_BONGOCAT 525 // number of bytes in array, minimize for adequate firmware size, max is 1024
...
#else
static void render_slave_board(void) {
    // clang-format off
